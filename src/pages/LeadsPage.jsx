        ...
        <>
            ...
            <DashboardLayout>
                <div className="max-w-7xl mx-auto">
                    ...
                    {/* Add Lead Form */}
                    {showAddForm && (
                        <Card className="bg-game-darker/50 border-game-purple/30 mb-6" hover={false}>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-game-dark/50 border border-game-purple/30 rounded-lg px-4 py-2 text-white focus:border-game-purple focus:outline-none"
                    ...
                    {/* Leads List */}
                    {leads.length === 0 ? (
                        <Card className="bg-game-darker/50 border-game-purple/30 p-12 text-center" hover={false}>
                        ...
                        <div className="space-y-4">
                            {leads.map(lead => (
                                <Card key={lead._id} className="bg-game-darker/50 border-game-purple/30" hover={false}>
                                    <div className="p-6">
                                        <div className="flex justify-between items-start mb-4 flex-wrap gap-4">
                                            ...
                                            <div className="flex items-center gap-3 flex-wrap">
                                                ...
                                                <select
                                                    ...
                                                    className="bg-game-dark/50 border border-game-purple/30 rounded-lg px-3 py-2 text-white text-sm focus:border-game-purple focus:outline-none"
                                                >
                                        ...
                                        {/* Note Section */}
                                        <div className="bg-game-dark/50 rounded-lg p-4">
                                            {editingNote === lead._id ? (
                                                <div className="flex gap-2">
                                                    <input
                                                        ...
                                                        className="flex-1 bg-game-darker/50 border border-game-purple/30 rounded-lg px-3 py-2 text-white text-sm focus:border-game-purple focus:outline-none"
