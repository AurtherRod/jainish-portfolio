    ...
    <>
      ...
      <div className="min-h-screen pt-20 pb-10">
        <div className="container mx-auto px-4 py-6">
          <Link to="/games" className="inline-flex items-center text-gray-400 hover:text-white mb-6 transition-colors text-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
              ...
              <div className="card-hover rounded p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {game.tags.map((tag, index) => (
                    <span key={index} className="bg-gray-700/50 text-gray-300 px-3 py-1 rounded text-sm border border-gray-600">
                      {tag}
                    </span>
                  ))}
                </div>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="card-hover rounded p-6 mb-4">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div>
                    ...
                    <div className="text-white font-medium">{game.tags[0]}</div>
                  </div>
                  <div>
                    <div className="text-gray-400 mb-1">Made with</div>
                    <div className="flex flex-wrap gap-2 mt-2">
                      {game.tech.map((tech, index) => (
                        <span key={index} className="bg-blue-500/20 border border-blue-400/30 text-blue-300 px-2 py-1 rounded text-xs font-semibold">
                          {tech}
                        </span>
                      ))}
                    </div>
              ...
              {/* More Games */}
              <div className="card-hover rounded p-6">
                <h3 className="text-white font-bold mb-3 text-lg">More Games</h3>
                <Link
                  to="/games"
                  className="block w-full bg-gray-700 hover:bg-gray-600 text-white text-center py-2 rounded transition-all font-semibold"
                >
                  Browse All Games
                </Link>
              </div>
