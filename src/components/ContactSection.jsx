  ...
  return (
    <section id="contact" className="py-20 md:py-32 bg-gray-900">
      <div className="container mx-auto px-6 text-center scroll-reveal">
        ...
        <a href="mailto:jainishgupta2000@gmail.com" className="mt-8 inline-block bg-green-500 text-gray-900 font-bold px-8 py-4 rounded-lg uppercase tracking-wider hover:bg-green-400 transition-transform transform hover:scale-105 hover:shadow-lg neon-shadow">
          Say Hello
        </a>
      </div>
    </section>
